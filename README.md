...
To build the final jar and optimize the dockerfour application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v8.8.0/microservices-architecture/#jhipster-registry
